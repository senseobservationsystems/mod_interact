...
%%% On Ubuntu
{'src/mod_offline_post', [{outdir, "ebin"},{i,"$HOME/lib/ejabberd*/include/"}]}.
{'src/mod_available_post', [{outdir, "ebin"},{i,"$HOME/lib/ejabberd*/include/"}]}.
{'src/mod_unavailable_post', [{outdir, "ebin"},{i,"$HOME/lib/ejabberd*/include/"}]}.
